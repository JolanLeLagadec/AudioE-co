    ...
    return (
        ...
        <div className='py-8 mx-auto container  '>
            <div className='flex flex-col items-center justify-center  w-full '>
                <div className='flex flex-col items-center justify-center gap-5 md:gap-24 md:flex-row md:text-left mt-32 relative'>
                    <GoBack />
                    <Image
                        src={newUrl}
                        width={400}
                    ...
                    />
                    <div className='mx-auto container w-full flex justify-center px-6'>
                        <div className='flex flex-col justify-center  w-full md:items-start gap-4 md:gap-6 lg:gap-10 md:basis-1/3 mt-6 lg:mt-0'>
                            <h1 className='text-3xl font-bold text-center uppercase lg:text-3xl w-[20rem] lg:w-[25rem]'>{product.name}</h1>
                            <p className='w-[320px] md:w-[20rem] leading-7 text-neutralBlack opacity-75 lg:w-[30rem]'>{product.description}</p>
                            <span className='text-black font-extrabold text-md text-left'>$ {product.price}</span>
